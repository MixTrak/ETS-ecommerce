...
const SearchPageContent: React.FC = () => {
  ...
  const searchProducts = async () => {
    ...
    try {
      ...
      // Client-side filter for name/tags (case-insensitive)
          ...
          <div className="navbar-end">
            {currentUser ? (
              <div className="dropdown dropdown-end">
                ...
                <ul className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow rounded-box w-52 bg-base-100 border border-base-300">
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <AnimatedElement variant="fadeInLeft" duration={0.7}>
            <div className={`${showFilters ? "block" : "hidden lg:block"} lg:w-[350px]`}>
